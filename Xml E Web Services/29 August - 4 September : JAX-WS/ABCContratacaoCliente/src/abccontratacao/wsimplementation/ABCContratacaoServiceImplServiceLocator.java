...
public class ABCContratacaoServiceImplServiceLocator extends org.apache.axis.client.Service
		implements abccontratacao.wsimplementation.ABCContratacaoServiceImplService {
	...
	public ABCContratacaoServiceImplServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public abccontratacao.wsinterface.ABCContratacaoService getABCContratacaoServiceImplPort(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			abccontratacao.wsimplementation.ABCContratacaoServiceImplPortBindingStub _stub = new abccontratacao.wsimplementation.ABCContratacaoServiceImplPortBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (abccontratacao.wsinterface.ABCContratacaoService.class.isAssignableFrom(serviceEndpointInterface)) {
				abccontratacao.wsimplementation.ABCContratacaoServiceImplPortBindingStub _stub = new abccontratacao.wsimplementation.ABCContratacaoServiceImplPortBindingStub(
						new java.net.URL(ABCContratacaoServiceImplPort_address), this);
				_stub.setPortName(getABCContratacaoServiceImplPortWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://wsimplementation.abccontratacao/",
				"ABCContratacaoServiceImplService");
	}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName("http://wsimplementation.abccontratacao/",
					"ABCContratacaoServiceImplPort"));
		}
