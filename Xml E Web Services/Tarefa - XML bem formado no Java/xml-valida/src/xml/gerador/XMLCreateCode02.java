 ...
 * @author andre endo
 * 
 * Criando um arquivo xml usando DOM e namespace
 * 
 */
public class XMLCreateCode02 {
    ...
    public static void main(String[] args) {
        try {
            ...
            Element catalogo = document.createElementNS("http://utfpr.edu.br/specJava", "catalogo");
            catalogo.setPrefix("m");
            document.appendChild(catalogo);
            Element cd1 = document.createElementNS("http://utfpr.edu.br/specJava", "m:cd");
            ...
            //salvar em arquivo
            transformDomToFile(document, "./public/saida2.xml");
            //salvar como string
